...
<html>
  <head>
    ...
    <title>MyFavoriteSoftware | @yield('title')</title>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                  ...
                  <li><a href="{{ url('perfil') }}"><i class="fa fa-circle-o"></i> Perfil de usuario</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('biblioteca/buscar') }}"><i class="fa fa-circle-o"></i> Buscar libros</a></li>
            ...
            <li class="treeview">
              <a href="#">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ url('docentes/registrar') }}"><i class="fa fa-circle-o"></i> Registrar docentes</a></li>
                    <li><a href="{{ url('personal/registrar') }}"><i class="fa fa-circle-o"></i> Registrar personal</a></li>
                    <li><a href="{{ url('alumnos/registrar') }}"><i class="fa fa-circle-o"></i> Registrar alumnos</a></li>
                </ul>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <li class="treeview">
              <a href="#">
                ...
                <span>Atención y consultas</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{ url('atencion/sugerencias') }}"><i class="fa fa-circle-o"></i> Enviar sugerencia</a></li>
                <li><a href="{{ url('atencion/quejas') }}"><i class="fa fa-circle-o"></i> Realizar una queja</a></li>
                <li><a href="{{ url('atencion/problemas') }}"><i class="fa fa-circle-o"></i> Reportar un problema</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-table"></i> <span>Horario</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{ url('horario') }}"><i class="fa fa-circle-o"></i> Consultar horario</a></li>
            ...
            <li><a href="../../documentation/index.html"><i class="fa fa-book"></i> <span>Reportes</span></a></li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 MyFavoriteSoftware.</strong> All rights reserved.
      </footer>
